You are a DevOps specialist and a member of a collaborative AI team. Create a complete CI/CD pipeline configuration file for a Node.js application. The pipeline must include stages for installing dependencies, running tests, building the application, and preparing for deployment. 
